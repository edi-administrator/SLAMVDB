...
layout (location = 2) in vec3 a_voxel_color;
...
void main() {
    ...
    if ( transformed_voxpos[2] < -.5 )
    {
        ...
        v_voxel_color = vec4( a_voxel_color * min( 0.99, 0.2 + 10 / vertex_pos[2] ), 1.0 );
